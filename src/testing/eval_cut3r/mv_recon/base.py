...
from src.testing.eval_cut3r.mv_recon.dataset_utils.transforms import ImgNorm
...
class BaseStereoViewDataset:
    ...
    def _crop_resize_if_necessary(
        self, image, depthmap, intrinsics, resolution, rng=None, info=None, fixed_dir=False
    ):
        """This function:
        ...
        if not fixed_dir:
            if H > 1.1 * W:
                ...
                resolution = resolution[::-1] # small, large
    ...
    def _crop_resize_if_necessary2(
        self, image, depthmap, depthmap_complete, intrinsics, resolution, rng=None, info=None, fixed_dir=False
    ):
        """This function:
        - first downsizes the image with LANCZOS inteprolation,
          which is better than bilinear interpolation in
        ...
        image, depthmap, depthmap_complete, intrinsics = cropping.rescale_image_depthmap2(
        ...
        return image, depthmap, depthmap_complete, intrinsics
