...
def accuracy_raw(gt_points, rec_points):
    """Return per-predicted-point distance to nearest GT point."""
    gt_kd = KDTree(gt_points)
    distances, idx = gt_kd.query(rec_points, workers=-1)
    return distances, idx


def completion_raw(gt_points, rec_points):
    """Return per-GT-point distance to nearest predicted point."""
