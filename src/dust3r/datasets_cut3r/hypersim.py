...
class HyperSim_Multi(BaseMultiViewDataset):
    def __init__(self, *args, split, ROOT, non_sequential_readout=False, 
                 max_interval=4, max_interval_test=6, **kwargs):
        self.ROOT = ROOT
        self.video = True
        self.is_metric = True
    ...
    def _get_views(self, idx, resolution, rng, num_views):
        ...
        for v, view_idx in enumerate(image_idxs):
            ...
            rgb_image, depthmap, depth_complete, intrinsics = self._crop_resize_if_necessary2(
                rgb_image, depthmap, depth_complete, intrinsics, resolution, rng=rng, info=view_idx
            )
