...
if __name__ == "__main__":
    # Quick test
    root = "data/cut3r_data/glass_segmentations/Trans10K"
    dataset = Trans10KGlassDataset(ROOT=root, split='train', num_views=1, resolution=(512, 512))
    print(f"Dataset size: {len(dataset)}")
    
    # Create logs directory for visualization
    log_dir = "logs/trans10k_glass_examples"
